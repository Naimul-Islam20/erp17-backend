                    ...
                    <tr>
                        ...
                        <td class="actions-cell">
                            <div class="action-group">
                                <a class="btn btn-primary icon-action-btn" href="{{ route('admin.newsletter-categories.edit', $category) }}" title="Edit" aria-label="Edit">
                                ...
                                <form method="POST" action="{{ route('admin.newsletter-categories.destroy', $category) }}" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
                                    <button class="btn btn-danger icon-action-btn" type="submit" onclick="return confirm('Delete this category?')" title="Delete" aria-label="Delete">
                                        <svg viewBox="0 0 24 24" aria-hidden="true">
                                            <path d="M3 6h18"></path>
